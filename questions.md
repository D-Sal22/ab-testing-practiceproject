...
*Whats is the problem we hope to solve?
...
*Did our testing indicate overwhelmingly significant disparities between the two test subjects?


## Data Sourcing
Reflect on what other data sources you can use to answer your stakeholders exploratory goals.

*Similar tests done at other competitor educational companies.

*Beyond our internal survey, what specific market trend reports or competitor datasets would provide the context needed to tell if our outcomes are truly transformative?

*In what ways can we integrate competitor performance data to validate our findings?